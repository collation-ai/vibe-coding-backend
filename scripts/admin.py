...
class AdminManager:
    ...
    async def generate_api_key(self, email: str, key_name: str, environment: str = "prod", expires_days: Optional[int] = None):
        ...
        try:
            ...
            await conn.execute(
                ...
                VALUES ($1, $2, $3, $4, $5)
                """,
                user_id, key_hash, f"vibe_{environment}", key_name, expires_at
            )
    ...
    async def assign_database(self, email: str, database_name: str, connection_string: str):
    ...
    async def grant_permission(self, email: str, database_name: str, schema_name: str, permission: str):
    ...
    async def list_permissions(self, email: Optional[str] = None):
        ...
        try:
            ...
            for row in rows:
                ...
                print(f"   {perm_icon} {row['database_name']}.{row['schema_name']} ({row['permission']})")
    ...
    while True:
        ...
        try:
            if choice == "1":
                ...
                print("Format: postgresql://user:pass@host:port/database?sslmode=require")
                ...
                confirm = input(f"Are you sure you want to deactivate {email}? (yes/no): ").strip()
...
async def main():
    ...
    parser.add_argument("--list-permissions", metavar="EMAIL", nargs="?", const="", help="List permissions")
