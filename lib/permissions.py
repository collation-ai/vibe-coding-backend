...
class PermissionManager:
    async def check_permission(
        ...
        async with pool.acquire() as conn:
            ...
            if user_permission == Permission.READ_ONLY and required_permission == Permission.READ_ONLY:
                return True
    ...
    def _get_required_permission(self, operation: str) -> Permission:
        ...
        read_operations = [
            'select', 'read', 'get', 'list', 'describe', 'show', 'explain'
        ]
        ...
        async with pool.acquire() as conn:
            await conn.execute(
                ...
                DO UPDATE SET 
                    ...
                    updated_at = NOW()
                """,
                user_id, database_name, schema_name, permission.value
            )
